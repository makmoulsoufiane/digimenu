  ...
  return (
    <section>
      ...
      <p className="mt-2 max-w-2xl text-sm leading-6 text-[#62757d]">
        Manage menus and follow table orders from scan to delivery.
      </p>

      <div className="mt-7 grid gap-4 sm:grid-cols-2">
        <Link
          to={ROUTES.orders}
          className="flex items-center gap-4 rounded-xl border border-[#dbe3e6] bg-white p-5 shadow-[0_1px_3px_rgba(22,55,65,0.04)] transition hover:border-[#aebfc5]"
        >
          <span className="grid h-11 w-11 place-items-center rounded-lg bg-[#edf5f7] text-[#1b6079]">
            <Icon name="bell" size={20} />
          </span>
          <span>
            <strong className="block text-sm">Track orders</strong>
            <span className="mt-1 block text-xs text-[#6a7b82]">
              Accept and deliver table orders
            </span>
          </span>
